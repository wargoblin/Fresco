          ...
          <div class="prefs-body">
                ...
                <div v-for="(day, i) in dayNames" :key="i" class="schedule-day">
                  <div class="schedule-day-header">
                    <label class="day-toggle">
                      <span class="toggle-switch toggle-sm" :class="{ on: dayEnabled[i] }" role="switch" :aria-checked="String(dayEnabled[i])" tabindex="0" @click.prevent="toggleDay(i, !dayEnabled[i])" @keydown.enter.prevent="toggleDay(i, !dayEnabled[i])" @keydown.space.prevent="toggleDay(i, !dayEnabled[i])">
            ...
            <div v-if="activeTab === 'manager'" class="prefs-section">
              ...
              <label class="pref-row">
                ...
                <span class="toggle-switch" :class="{ on: managerForm.showExitConfirmation }" role="switch" :aria-checked="String(managerForm.showExitConfirmation)" tabindex="0" @click.prevent="managerForm.showExitConfirmation = !managerForm.showExitConfirmation" @keydown.enter.prevent="managerForm.showExitConfirmation = !managerForm.showExitConfirmation" @keydown.space.prevent="managerForm.showExitConfirmation = !managerForm.showExitConfirmation">
                  <span class="toggle-knob" />
                </span>
              </label>
              ...
              <label class="pref-row">
                ...
                <span class="toggle-switch" :class="{ on: managerForm.showShutdownConfirmation }" role="switch" :aria-checked="String(managerForm.showShutdownConfirmation)" tabindex="0" @click.prevent="managerForm.showShutdownConfirmation = !managerForm.showShutdownConfirmation" @keydown.enter.prevent="managerForm.showShutdownConfirmation = !managerForm.showShutdownConfirmation" @keydown.space.prevent="managerForm.showShutdownConfirmation = !managerForm.showShutdownConfirmation">
                  <span class="toggle-knob" />
                </span>
              </label>
