...
export const mockHostInfo: HostInfo = {
  ...
  p_model: "Intel(R) Core(TM) i7-10700K CPU @ 3.80GHz [Family 6 Model 165 Stepping 5]",
  p_features: "fpu vme de pse tsc msr pae mce cx8 apic sep mtrr pge mca cmov pat pse36 clflush mmx fxsr sse sse2 ht",
  ...
  os_name: "Linux",
  os_version: "Ubuntu 22.04.3 LTS [6.5.0-44-generic|libc 2.35 (Ubuntu GLIBC 2.35-0ubuntu3.8)]",
